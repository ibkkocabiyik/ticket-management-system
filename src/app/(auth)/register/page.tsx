      ...
      <div className="relative z-10 hidden lg:flex lg:w-1/2 flex-col justify-between p-14">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-white/45" style={{ fontSize: "0.9375rem", lineHeight: 1.7, maxWidth: 380 }}>
            Birkaç saniyede hesabınızı oluşturun ve destek ekibinizle
            koordineli çalışmaya hemen başlayın.
          </p>

          {/* Özellik listesi */}
          <div className="mt-10 flex flex-col gap-3.5">
            {[
              { icon: "🚀", text: "Dakikalar içinde kurulum" },
              { icon: "👥", text: "Ekip bazlı rol yönetimi" },
              { icon: "📊", text: "Detaylı raporlama ve takip" },
            ].map((item) => (
